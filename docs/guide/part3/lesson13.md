...
![](https://blog.poetries.top/img/static/gitee/2019/11/10.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/11.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/12.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/13.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/14.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/15.png)

上面的标记过程和清除过程就是标记 - 清除算法，不过对一块内存多次执行标记 - 清除算法后，会产生大量不连续的内存碎片。而碎片过多会导致大对象无法分配到足够的连续内存，于是又产生了另外一种算法——标记 - 整理（Mark-Compact），这个标记过程仍然与标记 - 清除算法里的是一样的，但后续步骤不是直接对可回收对象进行清理，而是让所有存活的对象都向一端移动，然后直接清理掉端边界以外的内存。你可以参考下图


![](https://blog.poetries.top/img/static/gitee/2019/11/16.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/17.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/18.png)
