...
![](https://blog.poetries.top/img/static/gitee/2019/11/57.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/58.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/59.png)

然后按照同样的流程解析出来 StartTag body 和 StartTag div，其 Token 栈和 DOM 的状态如下图所示：

![](https://blog.poetries.top/img/static/gitee/2019/11/60.png)

接下来解析出来的是第一个 div 的文本 Token，渲染引擎会为该 Token 创建一个文本节点，并将该 Token 添加到 DOM 中，它的父节点就是当前 Token 栈顶元素对应的节点，如下图所示：


![](https://blog.poetries.top/img/static/gitee/2019/11/61.png)

再接下来，分词器解析出来第一个 EndTag div，这时候 HTML 解析器会去判断当前栈顶的元素是否是 StartTag div，如果是则从栈顶弹出 StartTag div，如下图所示

![](https://blog.poetries.top/img/static/gitee/2019/11/62.png)

按照同样的规则，一路解析，最终结果如下图所示：

![](https://blog.poetries.top/img/static/gitee/2019/11/63.png)
...
![](https://blog.poetries.top/img/static/gitee/2019/11/64.png)
